...
Poster frames for `public/video/qbot/`, named `<video-name>-poster.jpg`.
Any still images for the QBot page live here too.

Reference as `${import.meta.env.BASE_URL}images/qbot/<name>.jpg` — not a bare
